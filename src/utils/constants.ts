...
export const SocketIOPublicEvents = {
	...
	SCREEN_IMAGE_EVENT: "screen-image-event",
	...
	DEVICE_PERMISSION_EVENT: "device-permission-event",
...
export const SocketIOMobileEvents = {
	...
	MOBILE_CLIPBOARD_MONITOR: "mb-clipboard-event",
	...
	MOBILE_DEVICE_PERMISSION_EVENT: "mb-request-admin-monitor",
